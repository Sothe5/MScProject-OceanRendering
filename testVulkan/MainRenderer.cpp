...
private:
	...
	void createComputeShaderResources() {
		...
		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageHk0, computeShaderImageMemoryHk0);
		transitionImageLayout(computeShaderImageHk0, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewHk0 = createImageView(computeShaderImageHk0, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);
		
		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageHk0minus, computeShaderImageMemoryHk0minus);
		transitionImageLayout(computeShaderImageHk0minus, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewHk0minus = createImageView(computeShaderImageHk0minus, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageHkt, computeShaderImageMemoryHkt);
		transitionImageLayout(computeShaderImageHkt, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewHkt = createImageView(computeShaderImageHkt, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);
		...
		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageFFTAlternate, computeShaderImageMemoryFFTAlternate);
		transitionImageLayout(computeShaderImageFFTAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewFFTAlternate = createImageView(computeShaderImageFFTAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageHeightMap, computeShaderImageMemoryHeightMap);
		transitionImageLayout(computeShaderImageHeightMap, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewHeightMap = createImageView(computeShaderImageHeightMap, VK_FORMAT_R32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeX, computeShaderImageMemorySlopeX);
		transitionImageLayout(computeShaderImageSlopeX, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeX = createImageView(computeShaderImageSlopeX, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeXAlternate, computeShaderImageMemorySlopeXAlternate);
		transitionImageLayout(computeShaderImageSlopeXAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeXAlternate = createImageView(computeShaderImageSlopeXAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeXFinal, computeShaderImageMemorySlopeXFinal);
		transitionImageLayout(computeShaderImageSlopeXFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeXFinal = createImageView(computeShaderImageSlopeXFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeZ, computeShaderImageMemorySlopeZ);
		transitionImageLayout(computeShaderImageSlopeZ, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeZ = createImageView(computeShaderImageSlopeZ, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeZAlternate, computeShaderImageMemorySlopeZAlternate);
		transitionImageLayout(computeShaderImageSlopeZAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeZAlternate = createImageView(computeShaderImageSlopeZAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageSlopeZFinal, computeShaderImageMemorySlopeZFinal);
		transitionImageLayout(computeShaderImageSlopeZFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewSlopeZFinal = createImageView(computeShaderImageSlopeZFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispX, computeShaderImageMemoryDispX);
		transitionImageLayout(computeShaderImageDispX, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispX = createImageView(computeShaderImageDispX, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispXAlternate, computeShaderImageMemoryDispXAlternate);
		transitionImageLayout(computeShaderImageDispXAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispXAlternate = createImageView(computeShaderImageDispXAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispXFinal, computeShaderImageMemoryDispXFinal);
		transitionImageLayout(computeShaderImageDispXFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispXFinal = createImageView(computeShaderImageDispXFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispZ, computeShaderImageMemoryDispZ);
		transitionImageLayout(computeShaderImageDispZ, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispZ = createImageView(computeShaderImageDispZ, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispZAlternate, computeShaderImageMemoryDispZAlternate);
		transitionImageLayout(computeShaderImageDispZAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispZAlternate = createImageView(computeShaderImageDispZAlternate, VK_FORMAT_R32G32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);

		createImage(fourierGridSize, fourierGridSize, VK_FORMAT_R32_SFLOAT, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, computeShaderImageDispZFinal, computeShaderImageMemoryDispZFinal);
		transitionImageLayout(computeShaderImageDispZFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_GENERAL,1);
		computeShaderImageViewDispZFinal = createImageView(computeShaderImageDispZFinal, VK_FORMAT_R32_SFLOAT, VK_IMAGE_ASPECT_COLOR_BIT);
	}
